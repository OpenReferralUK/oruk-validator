...
public class OpenApiValidationOptions
{
    ...
    /// </summary>
    [JsonPropertyName("testEndpoints")]
    ...
    /// Disabled by default to avoid external meta-schema resolution failures
    /// </summary>
    ...
    /// </summary>
    [DefaultValue(true)]
    [JsonPropertyName("skipAuthentication")]
    ...
    /// </summary>
    [DefaultValue(true)]
    [JsonPropertyName("testOptionalEndpoints")]
    ...
    /// </summary>
    [DefaultValue(true)]
    [JsonPropertyName("treatOptionalEndpointsAsWarnings")]
    ...
    /// </summary>
    [JsonPropertyName("returnRawResult")]
